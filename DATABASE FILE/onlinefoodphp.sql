...
CREATE TABLE `coupencode` (
  ...
  `coupennum` varchar(222) NOT NULL,
  `date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


INSERT INTO `coupencode` (`fname`, `lname`, `email`, `pass`, `feedback`, `gender`, `age`, `coupennum`, `date`) VALUES
('Deepak', 'surya', 'Deepaksurya23@gmail.com', 'Deepaksurya', 'Launch more games', 'male', '20', 'az34Fs', '2022-05-27 11:43:26'),
('Gokul', 'Raj', 'Gokulraj@gmail.com', 'Gokulraj', 'Launch more games', 'male', '12', 'Bd23he', '2024-10-13 01:23:26');
