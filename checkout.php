	...
	header('location:login.php');
												...
												$item_total += ($item["price"]*$item["quantity"]);
													...
													if($_POST['submit'])
													{
                                                        ...
                                                        /* $coupenv = $_POST['coupen'];
                                                        $SQL="insert into coupen(coupendb) values ('$coupenv')"; */
                                    ...
                                    <div class="cart-totals margin-b-20">
                                        ...
                                        <div class="cart-totals-fields">
											...
											<tbody>
                                                    ...
                                                    <tr>
                                                        <td>Enter your coupen code</td>
                                                        <td><form action="checkout.php" method="post"><input type="text" class="form-control btn-light" placeholder="Enter your coupen code" style="width: 35%;" name='coupen'></form></td>
                                                    </tr>
                                                    <tr>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 payment-options color-gray">
                                    ...
                                    <ul>
                                        <li>
                                            The coupen code will be applied in cash on delivery
                                        </li>
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>2/1640-1, Omsakthinagar, 13th street, Ramanathapuram.</p>
                                    <h5>Phone: 9003871029</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                    <p>Email : deepakr.offl@gmail.com</p>
                                   <p>insta : @starsurya2992</p>
                                   <p>linkedin : @Deepak R</p>
                                   <p>Github : @Deepakr.offl</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php
   if(isset($_POST['submit'])){
    ...
    "Insert into coupendb (coupencode) values ('$coupenname')";
    $conn-> close();
   }
?>
